...
public class Main {
   public static void main(String[] args) {
      ...
      user.setRegistrationDate(2021, 02, 22);
      ...
      // task2
      System.out.println("\nTask 2\n");
      Book book1 = new Book(new com.itschool.Classes.Task2.Author("Jack", "London"), new com.itschool.Classes.Task2.Title("Sea wolf"), ukrainianAddress2, new Text("Once upon a time..."));

      Book book2 = new Book();
      com.itschool.Classes.Task2.Author autor = new com.itschool.Classes.Task2.Author("Jack", "London");
      com.itschool.Classes.Task2.Title title = new com.itschool.Classes.Task2.Title("White silence");
      ...
      Figure oneangle = new Figure(p1, p2, p3, p4, p5);
      System.out.println(oneangle);
   }
}