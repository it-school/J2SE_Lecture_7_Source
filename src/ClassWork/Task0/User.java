...
public class User
{
	...
	private String generatePassword()
	{
		...
		for (int i = 0; i < 2; i++) {
			password = password.concat("" + new Character((char) (65 + random.nextInt(27))));
			password = password.concat("" + new Character((char) (97 + random.nextInt(27))));
			password = password.concat("" + new Character((char) (48 + random.nextInt(10))));
			password = password.concat("" + new Character((char) (33 + random.nextInt(13))));
		}
		return password;
	}
